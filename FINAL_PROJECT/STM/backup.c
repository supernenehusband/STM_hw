...
#define x_small_threshold 300
#define y_small_threshold 300
#define z_small_threshold 300
...
void Add_Acc_Service(void)
{
    ...
    aci_gatt_add_serv(UUID_TYPE_128, uuid128_base, PRIMARY_SERVICE, 7, &AccServiceHandle); //  if (ret != BLE_STATUS_SUCCESS) goto fail;
